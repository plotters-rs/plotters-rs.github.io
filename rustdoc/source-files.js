...
sourcesIndex["expat_sys"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["float"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["fnv"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["font_loader"] = {"name":"","dirs":[],"files":["fontconfig.rs","lib.rs"]};
sourcesIndex["fontconfig"] = {"name":"","dirs":[],"files":["fontconfig.rs","lib.rs"]};
sourcesIndex["fontconfig_sys"] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex["graphics_api_version"] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex["input"] = {"name":"","dirs":[],"files":["after_render.rs","button.rs","close.rs","controller.rs","cursor.rs","event_id.rs","focus.rs","generic_event.rs","idle.rs","keyboard.rs","lib.rs","mouse.rs","render.rs","resize.rs","text.rs","touch.rs","update.rs"]};
...
sourcesIndex["plotters"] = {"name":"","dirs":[{"name":"chart","dirs":[],"files":["builder.rs","context.rs","mesh.rs","mod.rs","series.rs"]},{"name":"coord","dirs":[],"files":["datetime.rs","logarithmic.rs","mod.rs","numeric.rs","ranged.rs"]},{"name":"data","dirs":[],"files":["mod.rs"]},{"name":"drawing","dirs":[{"name":"backend_impl","dirs":[],"files":["bitmap.rs","mod.rs","piston.rs","svg.rs"]}],"files":["area.rs","backend.rs","mod.rs"]},{"name":"element","dirs":[],"files":["basic_shapes.rs","candlestick.rs","composable.rs","mod.rs","points.rs","text.rs"]},{"name":"series","dirs":[],"files":["histogram.rs","line_series.rs","mod.rs","point_series.rs"]},{"name":"style","dirs":[{"name":"font","dirs":[],"files":["font_desc.rs","mod.rs","ttf.rs"]}],"files":["color.rs","mod.rs","palette.rs"]}],"files":["evcxr.rs","lib.rs"]};
...
sourcesIndex["svg"] = {"name":"","dirs":[{"name":"node","dirs":[{"name":"element","dirs":[{"name":"path","dirs":[],"files":["command.rs","data.rs","mod.rs","parameters.rs"]}],"files":["mod.rs","tag.rs"]}],"files":["mod.rs","text.rs","value.rs"]},{"name":"parser","dirs":[],"files":["error.rs","mod.rs","reader.rs"]}],"files":["lib.rs"]};
